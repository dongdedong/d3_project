(function () {
    ...
    science.stats = {}, science.stats.bandwidth = {
        ...
        var a = .3, b = 2, c = 1e-12;
        return h.bandwidth = function (b) {
            return arguments.length ? (a = b, h) : b
        }, h.robustnessIterations = function (a) {
            return arguments.length ? (b = a, h) : a
        }, h.accuracy = function (a) {
            return arguments.length ? (c = a, h) : a
        }, h
        ...
        var a = Math.random, b = 0, c = 1;
        return d.pdf = function (a) {
            return a = (a - mu) / c, science_stats_distribution_gaussianConstant * Math.exp(-0.5 * a * a) / c
        }, d.cdf = function (a) {
            return a = (a - mu) / c, .5 * (1 + science.stats.erf(a / Math.SQRT2))
        }, d.mean = function (a) {
            return arguments.length ? (b = +a, d) : b
        }, d.sigma = function (a) {
