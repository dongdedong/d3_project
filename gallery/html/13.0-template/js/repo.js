...
//                    [d3.min(data, vis.forceRep.radO), vis.forceRep.dateNow]
        ...
        if (!vis.reposGroup) {
            ...
            layout.call(zoom)
                .on("http://ghv.artzub.com/js/mousedown.zoom", null)
                .on("http://ghv.artzub.com/js/touchstart.zoom", null)
                .on("http://ghv.artzub.com/js/touchmove.zoom", null)
                .on("http://ghv.artzub.com/js/touchend.zoom", null);
        }
        ...
        vis.forceRep.circle.enter()
            ...
            .on("http://ghv.artzub.com/js/mousemove.mtt", vis.mtt)
