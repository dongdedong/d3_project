...
(function (vis) {
    vis.meArc = function(d) {
        ...
        d._g.selectAll("http://ghv.artzub.com/js/path.bar")
            .style({
                "fill-opacity" : .6,
                "stroke-width" : 1,
        ...
        d._g.selectAll("http://ghv.artzub.com/js/text.del, text.add")
    ...
    vis.mlArc = function(d) {
        ...
        d._g.selectAll("http://ghv.artzub.com/js/text.del")
            .style("visibility", d.stats && d.stats.delTextVis ? d.stats.delTextVis : "hidden");

        d._g.selectAll("http://ghv.artzub.com/js/text.add")
    ...
    vis.redrawStat = function(data, layer) {
        ...
        var cData = layer.cont.points.selectAll("http://ghv.artzub.com/js/g.com")
            ...
            if (d.stats.additions) {
                ...
                (this.labelAdd || (
                    this.labelAdd = g.append("text")
                        .attr("class", "add")
                        .attr("dy", "http://ghv.artzub.com/js/-.31em")
