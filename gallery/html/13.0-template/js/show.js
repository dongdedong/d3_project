        ...
        function insideRestartShow() {
            ...
            lCom.showCommitMessage = lCom.showCommitMessage || function (text) {
                ...
                lCom.append("text")
                    ...
                    .duration(200)
                    .style("font-size", "http://ghv.artzub.com/js/11.2pt")
                    .transition()
                    .duration(1500)
            ...
            defImg = new Image();
            defImg.src = "default.png"/*tpa=http://ghv.artzub.com/js/resource/default.png*/;

            particle = new Image();
            particle.src = "particle.png"/*tpa=http://ghv.artzub.com/js/resource/particle.png*/;
